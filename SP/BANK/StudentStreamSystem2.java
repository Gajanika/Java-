...
public class StudentStreamSystem2 {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("3. Display Students by Stream");
            ...
            switch (choice) {
                ...
                case 3:
                    sc.nextLine(); // Consume newline
                    System.out.print("Enter Stream to Display (Commerce/Maths/Science/Technology): ");
                    String displayStream = sc.nextLine();

                    StreamClass selectedStream = streamMap.get(displayStream);
                    if (selectedStream != null) {
                        System.out.println("\n### Displaying Students in Stream: " + displayStream + " ###");
                        selectedStream.displayStudents();
                    } else {
                        System.out.println("Invalid stream. Please try again.");
                    }
                    break;
